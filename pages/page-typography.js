                        ...
                        <article className="entry-wraper mb-50">
                            ...
                            <div className="author-bio p-30 mt-50 border-radius-10 bg-white wow fadeIn animated">
                                ...
                                <div className="author-info">
                                    <h4 className="font-weight-bold mb-20"><span className="vcard author"><span className="fn"><a href="author.html" title="Posted by Barbara Cartland" rel="author">FirstName LastName</a></span></span>
                                    </h4>
                                    <h5 className="text-muted">About author</h5>
                                    <div className="author-description text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit, ratione!</div>
