...
function test() {
  return (
    <main className="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
                ...
                <ul className="scrollable__content py-2">
                    <li>
                        ...
                        <ul className="menu__sub-open">
                            ...
                            <li>
                                <a href="side-menu-light-dashboard-overview-4.html" className="menu">
                                    <div className="menu__icon"> <i data-lucide="activity"></i> </div>
                    ...
                    <li>
                        ...
                        <ul className="">
                            ...
                            <li>
                                ...
                                <ul className="">
                                    <li>
                                        <a href="side-menu-light-product-list.html" className="menu">
                                            <div className="menu__icon"> <i data-lucide="zap"></i> </div>
                                            <div className="menu__title">Product List</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="side-menu-light-product-grid.html" className="menu">
                                            <div className="menu__icon"> <i data-lucide="zap"></i> </div>
                            ...
                            <li>
                                ...
                                <ul className="">
                                    <li>
                                        <a href="side-menu-light-transaction-list.html" className="menu">
                                            <div className="menu__icon"> <i data-lucide="zap"></i> </div>
                                            <div className="menu__title">Transaction List</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="side-menu-light-transaction-detail.html" className="menu">
                                            <div className="menu__icon"> <i data-lucide="zap"></i> </div>
                            ...
                            <li>
                                ...
                                <ul className="">
                                    <li>
                                        <a href="side-menu-light-seller-list.html" className="menu">
                                            <div className="menu__icon"> <i data-lucide="zap"></i> </div>
                                            <div className="menu__title">Seller List</div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="side-menu-light-seller-detail.html" className="menu">
                                            <div className="menu__icon"> <i data-lucide="zap"></i> </div>
                    ...
                    <div className="intro-x relative mr-3 sm:mr-6">
                        ...
                        <div className="search-result">
                            <div className="search-result__content">
                                ...
                                <div className="mb-5">
                                    <a href="" className="flex items-center mt-2">
                                        <div className="w-8 h-8 image-fit">
                                            <img alt="Midone - HTML Admin Template" className="rounded-full" src="dist/images/profile-8.jpg"/>
                                       </div>
                                    ...
                                    <a href="" className="flex items-center mt-2">
                                        ...
                                        <div className="ml-auto w-48 truncate text-slate-500 text-xs text-right">sylvesterstallone@left4code.com</div>
                                    </a>
                                </div>
                                ...
                                <a href="" className="flex items-center mt-2">
                                    <div className="w-8 h-8 image-fit">
                                        <img alt="Midone - HTML Admin Template" className="rounded-full" src="dist/images/preview-5.jpg"/>
                                    </div>
                                ...
                                <a href="" className="flex items-center mt-2">
                                    <div className="w-8 h-8 image-fit">
                                        <img alt="Midone - HTML Admin Template" className="rounded-full" src="dist/images/preview-11.jpg"/>
                                    </div>
                        ...
                        <div className="grid grid-cols-12 gap-6">
                            ...
                            <div className="col-span-12 mt-6 -mb-6 intro-y">
                                <div className="alert alert-dismissible show box bg-primary text-white flex items-center mb-6" role="alert">
                                    ...
                                    <button type="button" className="btn-close text-white" data-tw-dismiss="alert" aria-label="Close"> <i data-lucide="x" className="w-4 h-4"></i> </button>
                                </div>
                            </div>
                                ...
                                <div className="report-box-2 intro-y mt-12 sm:mt-5">
                                    <div className="box sm:flex">
                                        <div className="px-8 py-12 flex flex-col justify-center flex-1">
                                            <i data-lucide="shopping-bag" className="w-10 h-10 text-warning"></i> 
                                            ...
                                            <div className="report-box-2__indicator bg-success tooltip cursor-pointer" title="47% Higher than last month"> 47% <i data-lucide="chevron-up" className="w-4 h-4 ml-0.5"></i> </div>
                                            ...
                                            <button className="btn btn-outline-secondary relative justify-start rounded-full mt-12">
                                                Download Reports 
                                                <span className="w-8 h-8 absolute flex justify-center items-center bg-primary text-white rounded-full right-0 top-0 bottom-0 my-auto ml-auto mr-0.5"> <i data-lucide="arrow-right" className="w-4 h-4"></i> </span>
                                            </button>
                                        </div>
                                        <div className="px-8 py-12 flex flex-col justify-center flex-1 border-t sm:border-t-0 sm:border-l border-slate-200 dark:border-darkmode-300 border-dashed">
                                            ...
                                            <div className="mt-1.5 flex items-center">
                                                ...
                                                <div className="text-danger flex text-xs font-medium tooltip cursor-pointer ml-2" title="2% Lower than last month"> 2% <i data-lucide="chevron-down" className="w-4 h-4 ml-0.5"></i> </div>
                                            </div>
                                            <div className="text-slate-500 text-xs mt-5">CANCELATION CASE</div>
                                            <div className="mt-1.5 flex items-center">
                                                <div className="text-base">2</div>
                                                <div className="text-danger flex text-xs font-medium tooltip cursor-pointer ml-2" title="0.1% Lower than last month"> 0.1% <i data-lucide="chevron-down" className="w-4 h-4 ml-0.5"></i> </div>
                                            </div>
                                            <div className="text-slate-500 text-xs mt-5">GROSS RENTAL VALUE</div>
                                            <div className="mt-1.5 flex items-center">
                                                <div className="text-base">$72.000</div>
                                                <div className="text-success flex text-xs font-medium tooltip cursor-pointer ml-2" title="49% Higher than last month"> 49% <i data-lucide="chevron-up" className="w-4 h-4 ml-0.5"></i> </div>
                                            </div>
                                            <div className="text-slate-500 text-xs mt-5">GROSS RENTAL PROFIT</div>
                                            <div className="mt-1.5 flex items-center">
                                                <div className="text-base">$54.000</div>
                                                <div className="text-success flex text-xs font-medium tooltip cursor-pointer ml-2" title="52% Higher than last month"> 52% <i data-lucide="chevron-up" className="w-4 h-4 ml-0.5"></i> </div>
                                            </div>
                                    ...
                                    <div className="box p-5">
                                        <div className="flex items-center">
                                            ...
                                            <div className="dropdown ml-auto">
                                                <a className="dropdown-toggle w-5 h-5 block -mr-2" href="javascript:;" aria-expanded="false" data-tw-toggle="dropdown"> <i data-lucide="more-vertical" className="w-5 h-5 text-slate-500"></i> </a>
                                                <div className="dropdown-menu w-40">
                                                    <ul className="dropdown-content">
                                                        <li>
                                                            <a href="" className="dropdown-item"> <i data-lucide="file-text" className="w-4 h-4 mr-2"></i> Export </a>
                                                        </li>
                                                        <li>
                                                            <a href="" className="dropdown-item"> <i data-lucide="settings" className="w-4 h-4 mr-2"></i> Settings </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div className="border-b border-slate-200 flex pb-2 mt-4">
                                            ...
                                            <div className="text-success flex text-xs font-medium tooltip cursor-pointer ml-auto" title="49% Lower than last month"> 49% <i data-lucide="chevron-up" className="w-4 h-4 ml-0.5"></i> </div>
                                        </div>
                                    ...
                                    <div className="box p-5">
                                        <ul className=" nav nav-pills w-4/5 bg-slate-100 dark:bg-black/20 rounded-md mx-auto " role="tablist" >
                                            ...
                                            <li id="inactive-users-tab" className="nav-item flex-1" role="presentation">
                                                <button className="nav-link w-full py-1.5 px-2" data-tw-toggle="pill" data-tw-target="#inactive-users" type="button" role="tab" aria-selected="false" > Inactive </button>
                                            </li>
                                        </ul>
                            ...
                            <div className="col-span-12 lg:col-span-8 mt-6">
                                <div className="intro-y block sm:flex items-center h-10">
                                    ...
                                    <div className="sm:ml-auto mt-3 sm:mt-0 relative text-slate-500">
                                        ...
                                        <input type="text" className="form-control sm:w-56 box pl-10" placeholder="Filter by city"/>
                                    </div>
                                </div>
                                ...
                                <div className="mt-5">
                                    <div className="intro-y">
                                        <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                            ...
                                            <div className="ml-4 mr-auto">
                                                ...
                                                <div className="text-slate-500 text-xs mt-0.5">1 June 2021</div>
                                            </div>
                                    ...
                                    <div className="intro-y">
                                        <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                            ...
                                            <div className="ml-4 mr-auto">
                                                ...
                                                <div className="text-slate-500 text-xs mt-0.5">5 April 2021</div>
                                            </div>
                                            <div className="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">137 Sales</div>
                                        </div>
                                    </div>
                                    <div className="intro-y">
                                        <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                            ...
                                            <div className="ml-4 mr-auto">
                                                ...
                                                <div className="text-slate-500 text-xs mt-0.5">8 March 2021</div>
                                            </div>
                                            <div className="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">137 Sales</div>
                                        </div>
                                    </div>
                                    <div className="intro-y">
                                        <div className="box px-4 py-4 mb-3 flex items-center zoom-in">
                                            ...
                                            <div className="ml-4 mr-auto">
                                                <div className="font-medium">Brad Pitt</div>
                                                <div className="text-slate-500 text-xs mt-0.5">18 September 2022</div>
                                            </div>
                                            <div className="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">137 Sales</div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-span-12 lg:col-span-6 mt-6">
                                <div className="box p-8 relative overflow-hidden bg-primary intro-y">
                                    ...
                                    <img className="hidden sm:block absolute top-0 right-0 w-2/5 -mt-3 mr-2" alt="Midone - HTML Admin Template" src="dist/images/woman-illustration.svg"/>
                                </div>
                            </div>
                            ...
                            <div className="col-span-12 lg:col-span-6 mt-6">
                                <div className="box p-8 relative overflow-hidden intro-y">
                                    ...
                                    <div className="w-48 relative mt-6 cursor-pointer tooltip" title="Copy referral link">
                                        ...
                                        <i data-lucide="copy" className="absolute right-0 top-0 bottom-0 my-auto mr-4 w-4 h-4"></i> 
                                    </div>
                                    <img className="hidden sm:block absolute top-0 right-0 w-1/2 mt-1 -mr-12" alt="Midone - HTML Admin Template" src="dist/images/phone-illustration.svg"/>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                                ...
                                                <td className="w-40">
                                                    <div className="flex">
                                                        <div className="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="dist/images/preview-5.jpg" title="Uploaded at 1 June 2021"/>
                                                        </div>
                                                        <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="dist/images/preview-10.jpg" title="Uploaded at 25 June 2020"/>
                                                        </div>
                                                        <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="dist/images/preview-10.jpg" title="Uploaded at 26 October 2022"/>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr className="intro-x">
                                                <td className="w-40">
                                                    <div className="flex">
                                                        <div className="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="dist/images/preview-3.jpg" title="Uploaded at 5 April 2021"/>
                                                        </div>
                                                        <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="dist/images/preview-6.jpg" title="Uploaded at 15 November 2020"/>
                                                        </div>
                                                        <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="dist/images/preview-15.jpg" title="Uploaded at 5 August 2022"/>
                                                       </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr className="intro-x">
                                                <td className="w-40">
                                                    <div className="flex">
                                                        <div className="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="dist/images/preview-4.jpg" title="Uploaded at 8 March 2021"/>
                                                        </div>
                                                        <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="dist/images/preview-5.jpg" title="Uploaded at 25 December 2021"/>
                                                        </div>
                                                        <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="dist/images/preview-2.jpg" title="Uploaded at 6 September 2020"/>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr className="intro-x">
                                                <td className="w-40">
                                                    <div className="flex">
                                                        <div className="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="dist/images/preview-9.jpg" title="Uploaded at 18 September 2022"/>
                                                        </div>
                                                        <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="dist/images/preview-12.jpg" title="Uploaded at 28 July 2021"/>
                                                        </div>
                                                        <div className="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Midone - HTML Admin Template" className="tooltip rounded-full" src="dist/images/preview-13.jpg" title="Uploaded at 7 July 2022"/>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <div className="tiny-slider" id="important-notes">
                                                <div className="p-5">
                                                    ...
                                                    <div className="font-medium flex mt-5">
                                                        ...
                                                        <button type="button" className="btn btn-outline-secondary py-1 px-2 ml-auto">Dismiss</button>
                                                    </div>
                                                </div>
                                                <div className="p-5">
                                                    <div className="text-base font-medium truncate">Lorem Ipsum is simply dummy text</div>
                                    ...
                                    <div className="mt-5 relative before:block before:absolute before:w-px before:h-[85%] before:bg-slate-200 before:dark:bg-darkmode-400 before:ml-5 before:mt-5">
                                                ...
                                                <div className="text-slate-500">
                                                    ...
                                                    <div className="flex mt-2">
                                                        <div className="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Dell XPS 13">
                                                            <img alt="Midone - HTML Admin Template" className="rounded-md border border-white" src="dist/images/preview-10.jpg"/>
                                                        </div>
                                                        <div className="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Samsung Galaxy S20 Ultra">
                                                            <img alt="Midone - HTML Admin Template" className="rounded-md border border-white" src="dist/images/preview-9.jpg"/>
                                                        </div>
                                                        <div className="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Samsung Q90 QLED TV">
                                                            <img alt="Midone - HTML Admin Template" className="rounded-md border border-white" src="dist/images/preview-4.jpg"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="intro-x relative flex items-center mb-3">
                                            ...
                                            <div className="box px-5 py-3 ml-4 flex-1 zoom-in">
                                                ...
                                                <div className="text-slate-500 mt-1">Has changed <a className="text-primary" href="">Nikon Z6</a> description</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="mt-5">
                                        <div className="intro-x">
                                            <div className="box px-5 py-3 mb-3 flex items-center zoom-in">
                                                ...
                                                <div className="text-danger">-$28</div>
                                            </div>
                                        </div>
                                        <div className="intro-x">
                                            <div className="box px-5 py-3 mb-3 flex items-center zoom-in">
                                        ...
                                        <div className="intro-x">
                                            <div className="box px-5 py-3 mb-3 flex items-center zoom-in">
                                                ...
                                                <div className="ml-4 mr-auto">
                                                    <div className="font-medium">Al Pacino</div>
                                                    <div className="text-slate-500 text-xs mt-0.5">17 December 2021</div>
                                                </div>
                                                <div className="text-danger">-$81</div>
                                            </div>
                                        </div>
